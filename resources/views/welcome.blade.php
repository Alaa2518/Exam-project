            ...
            @if (Route::has('login'))
                <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
                    ...
                    @else
                        ...
                        <a href="{{ route('code') }}" class="text-sm text-gray-700 dark:text-gray-500 underline ml-4">Log in with code</a>
...
<head>
  ...
  <meta content="xam app help teachers to test ther students esy way  " name="description">
